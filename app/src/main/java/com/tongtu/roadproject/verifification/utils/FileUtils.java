...
import com.tongtu.roadproject.verifification.service.DownloadService;
...
public class FileUtils {
    ...
    private static void closeIO(InputStream in, OutputStream out) {
        try {
            in.close();
            out.close();
        } catch (IOException e) {
    ...
    private static void closeIO(FileChannel in, FileChannel out) {
        try {
            in.close();
            out.close();
        } catch (IOException e) {
